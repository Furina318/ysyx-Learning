...
#define ECALL(NO, dnpc) {IFDEF(CONFIG_E_TRACE,printf("\033[32m[ecall]: dnpc = 0x%08x\033[0m\n",isa_raise_intr(NO, s->pc)));\
...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  // INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , R, R(rd) = (uint32_t)src2 != 0 ? ((uint32_t)src1 / (uint32_t)src2) : (uint32_t)-1);
  // INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, R(rd) = ( int32_t)src2 != 0 ? (( int32_t)src1 / ( int32_t)src2) : ( int32_t)-1);
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , R, if (( int32_t)src2 == 0) R(rd) = ( int32_t)src1; else if ((int32_t)src1 == (int32_t)0x80000000 && (int32_t)src2 == -1) R(rd) = 0; else R(rd) = ( int32_t)src1 % ( int32_t)src2);
  INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu   , R, if ((uint32_t)src2 == 0) R(rd) = (uint32_t)src1; else R(rd) = (uint32_t)src1 % (uint32_t)src2);
  INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , R, if ((uint32_t)src2 == 0) R(rd) = (uint32_t)-1  ; else R(rd) = (uint32_t)src1 / (uint32_t)src2);
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, if (( int32_t)src2 == 0) R(rd) = ( int32_t)-1  ; else if ((int32_t)src1 == (int32_t)0x80000000 && (int32_t)src2 == -1) R(rd) = (int32_t)0x80000000; else R(rd) = (int32_t)src1 / (int32_t)src2);
