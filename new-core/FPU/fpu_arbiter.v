...
//////////////////////////////////////////////////////////////////////////////
//
// fpu_arbiter - FPU 写回仲裁器（基于年龄）
//
// 功能：
//   多个 FPU 执行单元完成时间不同，允许乱序完成、乱序写回。
//   同一周期多个单元同时请求写回时，优先选择年龄最老的指令。
//
// 年龄判定：
//   使用循环 ID 比较。ID 越小代表年龄越老；ID 回绕时按模 2^ID_WIDTH
//   距离判断，保证乱序核中的年龄语义正确。
//
// 接口：
//   每个端口提供 valid/id/data/fflags；
//   仲裁结果输出到唯一写回端口。
//////////////////////////////////////////////////////////////////////////////
