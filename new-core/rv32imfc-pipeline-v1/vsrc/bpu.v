module bpu #(
    ...
    /* verilator lint_off UNUSEDPARAM */ // PHT_WIDE: 预留, 当前未使用
    ...
    wire [31:0]           pred_target2_unused;
    wire                  pred_valid2_unused;
    wire [1:0]            pred_conf2_unused;
    ...
    ittage #(
        ...
        .br_taken1    (bru_taken                                         ),
        .fetch_pc2    ('b0                                               ),
        .pred_target2 (pred_target2_unused                               ),
        .pred_valid2  (pred_valid2_unused                                ),
        .pred_conf2   (pred_conf2_unused                                 ),
        .update_en2   (1'b0                                              ),
        .update_pc2   ('b0                                               ), 
        .real_target2 ('b0                                               ), 
        .br_taken2    (1'b0                                              )
