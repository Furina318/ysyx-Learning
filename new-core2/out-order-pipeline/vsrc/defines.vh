...
// bus width
`define IF_TO_ID_WD 148          // 102 + 46 (per-inst: ghr32+provider3+alt1+dir1+ras_ptr4+ras_cnt5)
`define ID_TO_EX_WD 243          // 197 + 46
...
`define ID_TO_IS_WD 243          // 197 + 46
`define IS_TO_EX_WD 243          // 197 + 46
