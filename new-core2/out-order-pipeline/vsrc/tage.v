module tage #(
    ...
    input  wire [GHR_WIDTH-1:0] pred_ghr2       , // slot2 使用的 GHR (应包含 slot1 的投机更新)
    ...
    wire [T_IDX_W-1:0] t1_pred_idx_2 = pred_pc2[2 +: T_IDX_W] ^ f_fold_idx(pred_ghr2, L1);
    wire [T_IDX_W-1:0] t2_pred_idx_2 = pred_pc2[2 +: T_IDX_W] ^ f_fold_idx(pred_ghr2, L2);
    wire [T_IDX_W-1:0] t3_pred_idx_2 = pred_pc2[2 +: T_IDX_W] ^ f_fold_idx(pred_ghr2, L3);
    wire [T_IDX_W-1:0] t4_pred_idx_2 = pred_pc2[2 +: T_IDX_W] ^ f_fold_idx(pred_ghr2, L4);

    wire [TAG_WIDTH-1:0] t1_pred_tag_2 = pred_pc2[2+T_IDX_W +: TAG_WIDTH] ^ f_fold_tag(pred_ghr2, L1);
    wire [TAG_WIDTH-1:0] t2_pred_tag_2 = pred_pc2[2+T_IDX_W +: TAG_WIDTH] ^ f_fold_tag(pred_ghr2, L2);
    wire [TAG_WIDTH-1:0] t3_pred_tag_2 = pred_pc2[2+T_IDX_W +: TAG_WIDTH] ^ f_fold_tag(pred_ghr2, L3);
    wire [TAG_WIDTH-1:0] t4_pred_tag_2 = pred_pc2[2+T_IDX_W +: TAG_WIDTH] ^ f_fold_tag(pred_ghr2, L4);
