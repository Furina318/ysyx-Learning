...
//   0xffc10113,    // addi sp, sp, -4          // sp = 0x80000ffc
//   0x06400593,    // li a1, 100               // a1 = 100
//   0x03258613,    // addi a2, a1, 50          // a2 = 150
//   0x00c12023,    // sw a2, 0(sp)             // 内存[sp + 0] = a2 (存150到0x80000ffc)
//   0x00012683,    // lw a3, 0(sp)             // a3 = 内存[sp + 0] = 150
//   0x06468693,    // addi a3, a3, 100         // a3 = 150 + 100 = 250
//   0xf0068713,    // addi a4, a3, -256        // a4 = 250 - 256 = -6
//   0x00e61463,    // bne a2, a4, 8            // 如果 a2 != a4，跳转到 PC+8
//   0x00100073,    // ebreak                   // 未跳转则触发
//   0x00000297,    // auipc t0, 0              // t0 = 当前PC
//   0x00428293,    // addi t0, t0, 4           // t0 = t0 + 4
//   0x00c58863,    // bne a1, a2, 16           // 如果 a1 != a2，跳转到 PC+16
//   0x06458593,    // addi a1, a1, 100         // a1 = a1 + 100 (跳过)
//   0x00100073,    // ebreak                   // 触发调试
//   0xdeadbeef     // 数据段：0xdeadbeef
// };
static const word_t img[] = {
  0x80000137,          // lui   sp, 0x80000       // sp = 0x80000000
  0xffc10113,          // addi  sp, sp, 0xffc     // sp = 0x80000000 + 0xffc = 0x80000ffc
  0x06400593,          // li    a1, 100           // a1 = 100
  0x03258613,          // addi  a2, a1, 50        // a2 = 150
