module ALU (
    ...
    always @(*) begin
        case (ALUctr[2:0])
            ...
            3'b001: Result = shift_out;  // 左移
            3'b010: Result = {31'b0, Less}; // 小于比较
            3'b011: Result = B;          // 直接输出 B
            3'b100: Result = xor_out;    // 异或
            3'b101: Result = shift_out;  // 右移
            3'b110: Result = or_out;     // 逻辑或
            3'b111: Result = and_out;    // 逻辑与
