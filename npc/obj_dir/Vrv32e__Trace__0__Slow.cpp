...
VL_ATTR_COLD void Vrv32e___024root__trace_init_sub__TOP__0(Vrv32e___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+59,"rs1_val", false,-1, 31,0);
    tracep->declBus(c+60,"rs2_val", false,-1, 31,0);
    tracep->declBus(c+69,"wb_data", false,-1, 31,0);
    ...
    tracep->declBit(c+63,"alu_zero", false,-1);
    tracep->declBit(c+64,"alu_less", false,-1);
    tracep->declBit(c+70,"take_branch", false,-1);
    tracep->declBus(c+51,"MemLen", false,-1, 1,0);
    tracep->declBus(c+71,"branch_target", false,-1, 31,0);
    ...
    tracep->declBit(c+64,"less", false,-1);
    ...
    tracep->declBus(c+73,"immR", false,-1, 31,0);
    ...
    tracep->declBit(c+68,"reset", false,-1);
    tracep->declBus(c+71,"branch_target", false,-1, 31,0);
    tracep->declBit(c+72,"pc_src", false,-1);
    tracep->declBus(c+35,"pc", false,-1, 31,0);
    tracep->declBus(c+36,"instr", false,-1, 31,0);
    tracep->declBit(c+58,"check", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+60,"data_in", false,-1, 31,0);
    tracep->declBus(c+51,"MemLen", false,-1, 1,0);
    tracep->declBus(c+1,"data_out", false,-1, 31,0);
...
VL_ATTR_COLD void Vrv32e___024root__trace_full_sub_0(Vrv32e___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+58,(vlSelf->rv32e__DOT__if_stage__DOT__check));
    bufp->fullIData(oldp+59,(vlSelf->rv32e__DOT__rs1_val),32);
    bufp->fullIData(oldp+60,(vlSelf->rv32e__DOT__rs2_val),32);
    bufp->fullIData(oldp+61,((0xfffffffeU & vlSelf->rv32e__DOT____Vcellinp__mem_stage__addr)),32);
    bufp->fullIData(oldp+62,(vlSelf->rv32e__DOT__alu_result),32);
    bufp->fullBit(oldp+63,((0U == vlSelf->rv32e__DOT__alu_result)));
    bufp->fullBit(oldp+64,(vlSelf->rv32e__DOT__alu_less));
    bufp->fullIData(oldp+65,(vlSelf->rv32e__DOT____Vcellinp__alu__b),32);
    bufp->fullIData(oldp+66,(vlSelf->rv32e__DOT____Vcellinp__mem_stage__addr),32);
    bufp->fullBit(oldp+67,(vlSelf->clk));
    bufp->fullBit(oldp+68,(vlSelf->reset));
    bufp->fullIData(oldp+69,(((0x37U == (IData)(vlSelf->rv32e__DOT__opcode))
                                   ...
                                   : (((0x6fU == (IData)(vlSelf->rv32e__DOT__opcode)) 
                                       ...
                                       : ((3U == (IData)(vlSelf->rv32e__DOT__opcode))
                                           ...
                                           : (((0x33U 
                                               ...
                                               : 0U)))))),32);
    bufp->fullBit(oldp+70,(((0x63U == (IData)(vlSelf->rv32e__DOT__opcode)) 
    ...
    bufp->fullIData(oldp+71,(((IData)(vlSelf->rv32e__DOT__is_jalr)
                               ? (0xfffffffeU & vlSelf->rv32e__DOT____Vcellinp__mem_stage__addr)
                               : vlSelf->rv32e__DOT__jal_target)),32);
    bufp->fullBit(oldp+72,(((0x6fU == (IData)(vlSelf->rv32e__DOT__opcode)) 
