...
VL_ATTR_COLD void Vrv32e___024root__trace_init_sub__TOP__0(Vrv32e___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+62,"rs1_data", false,-1, 31,0);
    tracep->declBus(c+63,"rs2_data", false,-1, 31,0);
    tracep->declBus(c+3,"alu_result", false,-1, 31,0);
    tracep->declBus(c+64,"mem_data_out", false,-1, 31,0);
    tracep->declBus(c+81,"reg_write_data", false,-1, 31,0);
    tracep->declBit(c+4,"less", false,-1);
    tracep->declBit(c+5,"zero", false,-1);
    tracep->declBus(c+50,"i_type", false,-1, 2,0);
    tracep->declBit(c+51,"reg_wr", false,-1);
    tracep->declBit(c+52,"alu_a_src", false,-1);
    tracep->declBus(c+53,"alu_b_src", false,-1, 1,0);
    tracep->declBus(c+54,"alu_ctr", false,-1, 3,0);
    tracep->declBit(c+55,"mem_to_reg", false,-1);
    tracep->declBit(c+56,"mem_wr", false,-1);
    tracep->declBit(c+57,"mem_rd", false,-1);
    tracep->declBus(c+58,"mem_op", false,-1, 2,0);
    tracep->declBus(c+59,"branch", false,-1, 2,0);
    ...
    tracep->declBus(c+60,"time_counter", false,-1, 31,0);
    tracep->pushNamePrefix("alu_inst ");
    tracep->declBus(c+54,"ALUctr", false,-1, 3,0);
    tracep->declBit(c+52,"ALUAsrc", false,-1);
    tracep->declBus(c+53,"ALUBsrc", false,-1, 1,0);
    tracep->declBus(c+2,"imm", false,-1, 31,0);
    tracep->declBus(c+80,"PC", false,-1, 31,0);
    tracep->declBus(c+62,"rs1", false,-1, 31,0);
    ...
    tracep->declBus(c+61,"inst", false,-1, 31,0);
    tracep->declBus(c+50,"i_type", false,-1, 2,0);
    tracep->declBit(c+51,"RegWr", false,-1);
    tracep->declBit(c+52,"ALUAsrc", false,-1);
    tracep->declBus(c+53,"ALUBsrc", false,-1, 1,0);
    tracep->declBus(c+54,"ALUctr", false,-1, 3,0);
    tracep->declBit(c+55,"MemtoReg", false,-1);
    tracep->declBit(c+56,"MemWr", false,-1);
    tracep->declBit(c+57,"MemRd", false,-1);
    tracep->declBus(c+58,"MemOP", false,-1, 2,0);
    tracep->declBus(c+59,"Branch", false,-1, 2,0);
    tracep->declBus(c+68,"opcode", false,-1, 6,0);
    tracep->declBus(c+69,"func3", false,-1, 2,0);
    tracep->declBus(c+70,"func7", false,-1, 6,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+50,"i_type", false,-1, 2,0);
    tracep->declBus(c+2,"imm", false,-1, 31,0);
    tracep->declBus(c+71,"immI", false,-1, 31,0);
    tracep->declBus(c+72,"immU", false,-1, 31,0);
    tracep->declBus(c+73,"immS", false,-1, 31,0);
    tracep->declBus(c+74,"immB", false,-1, 31,0);
    tracep->declBus(c+75,"immJ", false,-1, 31,0);
    ...
    tracep->declBus(c+61,"inst_data", false,-1, 31,0);
    tracep->declBus(c+64,"data_out", false,-1, 31,0);
    tracep->declBus(c+76,"read_data", false,-1, 31,0);
    tracep->declBus(c+77,"temp_data", false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+62,"busA", false,-1, 31,0);
    tracep->declBus(c+63,"busB", false,-1, 31,0);
    for (int i = 0; i < 32; ++i) {
...
VL_ATTR_COLD void Vrv32e___024root__trace_full_sub_0(Vrv32e___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+50,(vlSelf->rv32e__DOT__i_type),3);
    bufp->fullBit(oldp+51,(vlSelf->rv32e__DOT__reg_wr));
    bufp->fullBit(oldp+52,(vlSelf->rv32e__DOT__alu_a_src));
    bufp->fullCData(oldp+53,(vlSelf->rv32e__DOT__alu_b_src),2);
    bufp->fullCData(oldp+54,(vlSelf->rv32e__DOT__alu_ctr),4);
    bufp->fullBit(oldp+55,(vlSelf->rv32e__DOT__mem_to_reg));
    bufp->fullBit(oldp+56,(vlSelf->rv32e__DOT__mem_wr));
    bufp->fullBit(oldp+57,(vlSelf->rv32e__DOT__mem_rd));
    bufp->fullCData(oldp+58,(vlSelf->rv32e__DOT__mem_op),3);
    bufp->fullCData(oldp+59,(vlSelf->rv32e__DOT__branch),3);
    bufp->fullIData(oldp+60,(vlSelf->rv32e__DOT__time_counter),32);
    bufp->fullIData(oldp+61,(vlSelf->rv32e__DOT__inst),32);
    bufp->fullIData(oldp+62,(vlSelf->rv32e__DOT__rs1_data),32);
    bufp->fullIData(oldp+63,(vlSelf->rv32e__DOT__rs2_data),32);
    bufp->fullIData(oldp+64,(vlSelf->rv32e__DOT__mem_data_out),32);
    ...
    bufp->fullCData(oldp+67,((0x1fU & (vlSelf->rv32e__DOT__inst 
                                       >> 7U))),5);
    bufp->fullCData(oldp+68,((0x7fU & vlSelf->rv32e__DOT__inst)),7);
    bufp->fullCData(oldp+69,((7U & (vlSelf->rv32e__DOT__inst 
                                    >> 0xcU))),3);
    bufp->fullCData(oldp+70,((vlSelf->rv32e__DOT__inst 
                              >> 0x19U)),7);
    bufp->fullIData(oldp+71,((((- (IData)((vlSelf->rv32e__DOT__inst 
                                           >> 0x1fU))) 
                               << 0xcU) | (vlSelf->rv32e__DOT__inst 
                                           >> 0x14U))),32);
    bufp->fullIData(oldp+72,((0xfffff000U & vlSelf->rv32e__DOT__inst)),32);
                               ...
                               << 0x14U) | ((0xff000U 
                                            ...
                                            | ((0x800U 
                                               ...
                                               | (0x7feU 
                                                  & (vlSelf->rv32e__DOT__inst 
                                                     >> 0x14U)))))),32);
    bufp->fullIData(oldp+76,(vlSelf->rv32e__DOT__mem_inst__DOT__read_data),32);
    bufp->fullIData(oldp+77,(vlSelf->rv32e__DOT__mem_inst__DOT__temp_data),32);
