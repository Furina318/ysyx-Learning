...
VL_ATTR_COLD void Vrv32e___024root__trace_init_sub__TOP__0(Vrv32e___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+195,"if_id_valid", false,-1);
    ...
    tracep->declBit(c+196,"id_ex_valid", false,-1);
    ...
    tracep->declBit(c+197,"ex_mem_valid", false,-1);
    ...
    tracep->declBit(c+198,"mem_wb_valid", false,-1);
    ...
    tracep->declBus(c+95,"rd_wb", false,-1, 4,0);
    tracep->declBit(c+96,"RegWrite_wb", false,-1);
    tracep->declBit(c+97,"stall", false,-1);
    tracep->declBit(c+98,"flush", false,-1);
    tracep->declBit(c+99,"forwordA", false,-1);
    tracep->declBit(c+100,"forwordB", false,-1);
    ...
    tracep->declBus(c+102,"next_state", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("id_stage ");
    tracep->declBit(c+193,"clk", false,-1);
    tracep->declBit(c+194,"reset", false,-1);
    tracep->declBus(c+2,"instr", false,-1, 31,0);
    tracep->declBit(c+103,"ex_ready", false,-1);
    tracep->declBit(c+53,"if_valid", false,-1);
    tracep->declBit(c+54,"id_ready", false,-1);
    tracep->declBit(c+71,"id_valid", false,-1);
    ...
    tracep->declBit(c+77,"is_ebreak", false,-1);
    tracep->declBus(c+104,"state", false,-1, 31,0);
    tracep->declBus(c+105,"next_state", false,-1, 31,0);
    ...
    tracep->declBus(c+199,"immR", false,-1, 31,0);
    tracep->declBus(c+111,"get_opcode", false,-1, 4,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("if_stage ");
    tracep->declBit(c+193,"clk", false,-1);
    tracep->declBit(c+194,"reset", false,-1);
    tracep->declBus(c+58,"branch_target", false,-1, 31,0);
    tracep->declBit(c+112,"pc_src", false,-1);
    tracep->declBit(c+113,"id_ready", false,-1);
    tracep->declBit(c+55,"wb_valid", false,-1);
    tracep->declBit(c+52,"if_ready", false,-1);
    tracep->declBit(c+53,"if_valid", false,-1);
    ...
    tracep->declBus(c+200,"rresp", false,-1, 1,0);
    tracep->declBus(c+116,"sram_araddr", false,-1, 31,0);
    tracep->declBit(c+117,"sram_arvalid", false,-1);
    tracep->declBit(c+118,"sram_arready", false,-1);
    tracep->declBus(c+119,"sram_rdata", false,-1, 31,0);
    tracep->declBit(c+120,"sram_rvalid", false,-1);
    tracep->declBit(c+121,"sram_rready", false,-1);
    tracep->declBus(c+122,"sram_rresp", false,-1, 1,0);
    tracep->declBus(c+201,"sram_awaddr", false,-1, 31,0);
    tracep->declBit(c+202,"sram_awvalid", false,-1);
    tracep->declBit(c+203,"sram_awready", false,-1);
    tracep->declBus(c+204,"sram_wdata", false,-1, 31,0);
    tracep->declBus(c+205,"sram_wstrb", false,-1, 3,0);
    tracep->declBit(c+206,"sram_wvalid", false,-1);
    tracep->declBit(c+203,"sram_wready", false,-1);
    tracep->declBus(c+207,"sram_bresp", false,-1, 1,0);
    tracep->declBit(c+203,"sram_bvalid", false,-1);
    tracep->declBit(c+208,"sram_bready", false,-1);
    tracep->pushNamePrefix("ifu_sram_inst ");
    tracep->declBus(c+209,"ADDR_WIDTH", false,-1, 31,0);
    tracep->declBus(c+209,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBit(c+193,"clk", false,-1);
    tracep->declBit(c+194,"reset", false,-1);
    tracep->declBus(c+116,"araddr", false,-1, 31,0);
    tracep->declBit(c+117,"arvalid", false,-1);
    tracep->declBit(c+118,"arready", false,-1);
    tracep->declBus(c+119,"rdata", false,-1, 31,0);
    tracep->declBit(c+120,"rvalid", false,-1);
    tracep->declBit(c+121,"rready", false,-1);
    tracep->declBus(c+122,"rresp", false,-1, 1,0);
    tracep->declBus(c+201,"awaddr", false,-1, 31,0);
    tracep->declBit(c+202,"awvalid", false,-1);
    tracep->declBit(c+203,"awready", false,-1);
    tracep->declBus(c+204,"wdata", false,-1, 31,0);
    tracep->declBus(c+205,"wstrb", false,-1, 3,0);
    tracep->declBit(c+206,"wvalid", false,-1);
    tracep->declBit(c+203,"wready", false,-1);
    tracep->declBus(c+207,"bresp", false,-1, 1,0);
    tracep->declBit(c+203,"bvalid", false,-1);
    tracep->declBit(c+208,"bready", false,-1);
    tracep->declBus(c+123,"sram_state", false,-1, 31,0);
    tracep->declBus(c+124,"next_sram_state", false,-1, 31,0);
    tracep->declBus(c+125,"araddr_reg", false,-1, 31,0);
    tracep->declBus(c+126,"rdata_reg", false,-1, 31,0);
    tracep->declBit(c+127,"addr_valid", false,-1);
    ...
    tracep->declBit(c+87,"store_access_fault", false,-1);
    tracep->declBus(c+88,"mem_fault_addr", false,-1, 31,0);
    tracep->declBus(c+129,"state", false,-1, 31,0);
    tracep->declBus(c+130,"next_state", false,-1, 31,0);
    tracep->declBus(c+131,"delay", false,-1, 1,0);
    tracep->declBus(c+210,"DELAY_CYCLES", false,-1, 31,0);
    tracep->declBus(c+132,"sram_araddr", false,-1, 31,0);
    tracep->declBit(c+133,"sram_arvalid", false,-1);
    tracep->declBit(c+134,"sram_arready", false,-1);
    tracep->declBus(c+135,"sram_rresp", false,-1, 1,0);
    tracep->declBus(c+136,"sram_rdata", false,-1, 31,0);
    tracep->declBit(c+137,"sram_rvalid", false,-1);
    tracep->declBit(c+138,"sram_rready", false,-1);
    tracep->declBus(c+139,"sram_awaddr", false,-1, 31,0);
    tracep->declBit(c+140,"sram_awready", false,-1);
    tracep->declBit(c+141,"sram_awvalid", false,-1);
    tracep->declBus(c+142,"sram_wdata", false,-1, 31,0);
    tracep->declBus(c+143,"sram_wstrb", false,-1, 3,0);
    tracep->declBit(c+144,"sram_wvalid", false,-1);
    tracep->declBit(c+145,"sram_wready", false,-1);
    tracep->declBus(c+146,"sram_bresp", false,-1, 1,0);
    tracep->declBit(c+147,"sram_bvalid", false,-1);
    tracep->declBit(c+148,"sram_bready", false,-1);
    tracep->pushNamePrefix("mem_sram_inst ");
    tracep->declBus(c+209,"ADDR_WIDTH", false,-1, 31,0);
    tracep->declBus(c+209,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBit(c+193,"clk", false,-1);
    tracep->declBit(c+194,"reset", false,-1);
    tracep->declBus(c+132,"araddr", false,-1, 31,0);
    tracep->declBit(c+133,"arvalid", false,-1);
    tracep->declBit(c+134,"arready", false,-1);
    tracep->declBus(c+136,"rdata", false,-1, 31,0);
    tracep->declBit(c+137,"rvalid", false,-1);
    tracep->declBit(c+138,"rready", false,-1);
    tracep->declBus(c+135,"rresp", false,-1, 1,0);
    tracep->declBus(c+139,"awaddr", false,-1, 31,0);
    tracep->declBit(c+141,"awvalid", false,-1);
    tracep->declBit(c+140,"awready", false,-1);
    tracep->declBus(c+142,"wdata", false,-1, 31,0);
    tracep->declBus(c+143,"wstrb", false,-1, 3,0);
    tracep->declBit(c+144,"wvalid", false,-1);
    tracep->declBit(c+145,"wready", false,-1);
    tracep->declBus(c+146,"bresp", false,-1, 1,0);
    tracep->declBit(c+147,"bvalid", false,-1);
    tracep->declBit(c+148,"bready", false,-1);
    tracep->declBus(c+149,"sram_state", false,-1, 31,0);
    tracep->declBus(c+150,"next_sram_state", false,-1, 31,0);
    tracep->declBus(c+151,"delay_counter", false,-1, 1,0);
    tracep->declBus(c+211,"DELAY_CYCLES", false,-1, 1,0);
    tracep->declBus(c+152,"araddr_reg", false,-1, 31,0);
    tracep->declBus(c+153,"awaddr_reg", false,-1, 31,0);
    tracep->declBus(c+154,"rdata_reg", false,-1, 31,0);
    tracep->declBus(c+155,"wdata_reg", false,-1, 31,0);
    tracep->declBus(c+156,"wstrb_reg", false,-1, 3,0);
    tracep->declBit(c+157,"addr_valid", false,-1);
    tracep->popNamePrefix(2);
    ...
    tracep->declBus(c+76,"rs2_val", false,-1, 31,0);
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+158+i*1,"regs", true,(i+0), 31,0);
    }
    ...
    tracep->declBit(c+96,"RegWrite_wb", false,-1);
    tracep->declBus(c+89,"wb_data", false,-1, 31,0);
    tracep->declBus(c+191,"state", false,-1, 31,0);
    tracep->declBus(c+192,"next_state", false,-1, 31,0);
    tracep->popNamePrefix(2);
}
...
VL_ATTR_COLD void Vrv32e___024root__trace_full_sub_0(Vrv32e___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+95,(vlSelf->rv32e__DOT__rd_wb),5);
    bufp->fullBit(oldp+96,(vlSelf->rv32e__DOT__RegWrite_wb));
    bufp->fullBit(oldp+97,(vlSelf->rv32e__DOT__stall));
    bufp->fullBit(oldp+98,(vlSelf->rv32e__DOT__flush));
    bufp->fullBit(oldp+99,(((IData)(vlSelf->rv32e__DOT__id_rs1) 
                            == (IData)(vlSelf->rv32e__DOT__mem_wb_rd))));
    bufp->fullBit(oldp+100,(((IData)(vlSelf->rv32e__DOT__id_rs2) 
                             == (IData)(vlSelf->rv32e__DOT__mem_wb_rd))));
    bufp->fullIData(oldp+101,(vlSelf->rv32e__DOT__ex_stage__DOT__state),32);
    bufp->fullIData(oldp+102,(vlSelf->rv32e__DOT__ex_stage__DOT__next_state),32);
    bufp->fullBit(oldp+103,(((~ (IData)(vlSelf->rv32e__DOT__stall)) 
                             & (IData)(vlSelf->rv32e__DOT__ex_ready))));
    bufp->fullIData(oldp+104,(vlSelf->rv32e__DOT__id_stage__DOT__state),32);
    bufp->fullIData(oldp+105,(vlSelf->rv32e__DOT__id_stage__DOT__next_state),32);
    bufp->fullIData(oldp+106,(vlSelf->rv32e__DOT__id_stage__DOT__immI),32);
    bufp->fullIData(oldp+107,((0xfffff000U & vlSelf->rv32e__DOT__if_id_instr)),32);
    bufp->fullIData(oldp+108,((((- (IData)((vlSelf->rv32e__DOT__if_id_instr 
                                ...
                                << 0xcU) | ((0xfe0U 
                                            ...
                                            | (0x1fU 
                                               & (vlSelf->rv32e__DOT__if_id_instr 
                                                  >> 7U))))),32);
    bufp->fullIData(oldp+109,((((- (IData)((vlSelf->rv32e__DOT__if_id_instr 
                                            >> 0x1fU))) 
                                << 0xcU) | ((0x800U 
                                             & (vlSelf->rv32e__DOT__if_id_instr 
                                                << 4U)) 
                                            | ((0x7e0U 
                                               ...
                                               | (0x1eU 
                                                  & (vlSelf->rv32e__DOT__if_id_instr 
                                                     >> 7U)))))),32);
    bufp->fullIData(oldp+110,((((- (IData)((vlSelf->rv32e__DOT__if_id_instr 
                                            >> 0x1fU))) 
                                << 0x14U) | ((0xff000U 
                                              & vlSelf->rv32e__DOT__if_id_instr) 
                                             | ((0x800U 
                                                ...
                                                | (0x7feU 
                                                   & (vlSelf->rv32e__DOT__if_id_instr 
                                                      >> 0x14U)))))),32);
    bufp->fullCData(oldp+111,(vlSelf->rv32e__DOT__id_stage__DOT__get_opcode),5);
    bufp->fullBit(oldp+112,(vlSelf->rv32e__DOT____Vcellinp__if_stage__pc_src));
    bufp->fullBit(oldp+113,(((~ (IData)(vlSelf->rv32e__DOT__stall)) 
                             & (IData)(vlSelf->rv32e__DOT__id_ready))));
    bufp->fullIData(oldp+114,(vlSelf->rv32e__DOT__if_stage__DOT__state),32);
    bufp->fullIData(oldp+115,(vlSelf->rv32e__DOT__if_stage__DOT__next_state),32);
    bufp->fullIData(oldp+116,(vlSelf->rv32e__DOT__if_stage__DOT__sram_araddr),32);
    bufp->fullBit(oldp+117,(vlSelf->rv32e__DOT__if_stage__DOT__sram_arvalid));
    bufp->fullBit(oldp+118,(vlSelf->rv32e__DOT__if_stage__DOT__sram_arready));
    bufp->fullIData(oldp+119,(vlSelf->rv32e__DOT__if_stage__DOT__sram_rdata),32);
    bufp->fullBit(oldp+120,(vlSelf->rv32e__DOT__if_stage__DOT__sram_rvalid));
    bufp->fullBit(oldp+121,(vlSelf->rv32e__DOT__if_stage__DOT__sram_rready));
    bufp->fullCData(oldp+122,(vlSelf->rv32e__DOT__if_stage__DOT__sram_rresp),2);
    bufp->fullIData(oldp+123,(vlSelf->rv32e__DOT__if_stage__DOT__ifu_sram_inst__DOT__sram_state),32);
    bufp->fullIData(oldp+124,(vlSelf->rv32e__DOT__if_stage__DOT__ifu_sram_inst__DOT__next_sram_state),32);
    bufp->fullIData(oldp+125,(vlSelf->rv32e__DOT__if_stage__DOT__ifu_sram_inst__DOT__araddr_reg),32);
    bufp->fullIData(oldp+126,(vlSelf->rv32e__DOT__if_stage__DOT__ifu_sram_inst__DOT__rdata_reg),32);
    bufp->fullBit(oldp+127,(((0x80000000U <= vlSelf->rv32e__DOT__if_stage__DOT__sram_araddr) 
                             & (0x8fffffffU >= vlSelf->rv32e__DOT__if_stage__DOT__sram_araddr))));
    bufp->fullCData(oldp+128,(vlSelf->rv32e__DOT__if_stage__DOT__ifu_sram_inst__DOT__delay_counter),2);
    bufp->fullIData(oldp+129,(vlSelf->rv32e__DOT__mem_stage__DOT__state),32);
    bufp->fullIData(oldp+130,(vlSelf->rv32e__DOT__mem_stage__DOT__next_state),32);
    bufp->fullCData(oldp+131,(vlSelf->rv32e__DOT__mem_stage__DOT__delay),2);
    bufp->fullIData(oldp+132,(vlSelf->rv32e__DOT__mem_stage__DOT__sram_araddr),32);
    bufp->fullBit(oldp+133,(vlSelf->rv32e__DOT__mem_stage__DOT__sram_arvalid));
    bufp->fullBit(oldp+134,(vlSelf->rv32e__DOT__mem_stage__DOT__sram_arready));
    bufp->fullCData(oldp+135,(vlSelf->rv32e__DOT__mem_stage__DOT__sram_rresp),2);
    bufp->fullIData(oldp+136,(vlSelf->rv32e__DOT__mem_stage__DOT__sram_rdata),32);
    bufp->fullBit(oldp+137,(vlSelf->rv32e__DOT__mem_stage__DOT__sram_rvalid));
    bufp->fullBit(oldp+138,(vlSelf->rv32e__DOT__mem_stage__DOT__sram_rready));
    bufp->fullIData(oldp+139,(vlSelf->rv32e__DOT__mem_stage__DOT__sram_awaddr),32);
    bufp->fullBit(oldp+140,(vlSelf->rv32e__DOT__mem_stage__DOT__sram_awready));
    bufp->fullBit(oldp+141,(vlSelf->rv32e__DOT__mem_stage__DOT__sram_awvalid));
    bufp->fullIData(oldp+142,(vlSelf->rv32e__DOT__mem_stage__DOT__sram_wdata),32);
    bufp->fullCData(oldp+143,(vlSelf->rv32e__DOT__mem_stage__DOT__sram_wstrb),4);
    bufp->fullBit(oldp+144,(vlSelf->rv32e__DOT__mem_stage__DOT__sram_wvalid));
    bufp->fullBit(oldp+145,(vlSelf->rv32e__DOT__mem_stage__DOT__sram_wready));
    bufp->fullCData(oldp+146,(vlSelf->rv32e__DOT__mem_stage__DOT__sram_bresp),2);
    bufp->fullBit(oldp+147,(vlSelf->rv32e__DOT__mem_stage__DOT__sram_bvalid));
    bufp->fullBit(oldp+148,(vlSelf->rv32e__DOT__mem_stage__DOT__sram_bready));
    bufp->fullIData(oldp+149,(vlSelf->rv32e__DOT__mem_stage__DOT__mem_sram_inst__DOT__sram_state),32);
    bufp->fullIData(oldp+150,(vlSelf->rv32e__DOT__mem_stage__DOT__mem_sram_inst__DOT__next_sram_state),32);
    bufp->fullCData(oldp+151,(vlSelf->rv32e__DOT__mem_stage__DOT__mem_sram_inst__DOT__delay_counter),2);
    bufp->fullIData(oldp+152,(vlSelf->rv32e__DOT__mem_stage__DOT__mem_sram_inst__DOT__araddr_reg),32);
    bufp->fullIData(oldp+153,(vlSelf->rv32e__DOT__mem_stage__DOT__mem_sram_inst__DOT__awaddr_reg),32);
    bufp->fullIData(oldp+154,(vlSelf->rv32e__DOT__mem_stage__DOT__mem_sram_inst__DOT__rdata_reg),32);
    bufp->fullIData(oldp+155,(vlSelf->rv32e__DOT__mem_stage__DOT__mem_sram_inst__DOT__wdata_reg),32);
    bufp->fullCData(oldp+156,(vlSelf->rv32e__DOT__mem_stage__DOT__mem_sram_inst__DOT__wstrb_reg),4);
    bufp->fullBit(oldp+157,(vlSelf->rv32e__DOT__mem_stage__DOT__mem_sram_inst__DOT__addr_valid));
    bufp->fullIData(oldp+158,(vlSelf->rv32e__DOT__reg_file__DOT__regs[0]),32);
    bufp->fullIData(oldp+159,(vlSelf->rv32e__DOT__reg_file__DOT__regs[1]),32);
    bufp->fullIData(oldp+160,(vlSelf->rv32e__DOT__reg_file__DOT__regs[2]),32);
    bufp->fullIData(oldp+161,(vlSelf->rv32e__DOT__reg_file__DOT__regs[3]),32);
    bufp->fullIData(oldp+162,(vlSelf->rv32e__DOT__reg_file__DOT__regs[4]),32);
    bufp->fullIData(oldp+163,(vlSelf->rv32e__DOT__reg_file__DOT__regs[5]),32);
    bufp->fullIData(oldp+164,(vlSelf->rv32e__DOT__reg_file__DOT__regs[6]),32);
    bufp->fullIData(oldp+165,(vlSelf->rv32e__DOT__reg_file__DOT__regs[7]),32);
    bufp->fullIData(oldp+166,(vlSelf->rv32e__DOT__reg_file__DOT__regs[8]),32);
    bufp->fullIData(oldp+167,(vlSelf->rv32e__DOT__reg_file__DOT__regs[9]),32);
    bufp->fullIData(oldp+168,(vlSelf->rv32e__DOT__reg_file__DOT__regs[10]),32);
    bufp->fullIData(oldp+169,(vlSelf->rv32e__DOT__reg_file__DOT__regs[11]),32);
    bufp->fullIData(oldp+170,(vlSelf->rv32e__DOT__reg_file__DOT__regs[12]),32);
    bufp->fullIData(oldp+171,(vlSelf->rv32e__DOT__reg_file__DOT__regs[13]),32);
    bufp->fullIData(oldp+172,(vlSelf->rv32e__DOT__reg_file__DOT__regs[14]),32);
    bufp->fullIData(oldp+173,(vlSelf->rv32e__DOT__reg_file__DOT__regs[15]),32);
    bufp->fullIData(oldp+174,(vlSelf->rv32e__DOT__reg_file__DOT__regs[16]),32);
    bufp->fullIData(oldp+175,(vlSelf->rv32e__DOT__reg_file__DOT__regs[17]),32);
    bufp->fullIData(oldp+176,(vlSelf->rv32e__DOT__reg_file__DOT__regs[18]),32);
    bufp->fullIData(oldp+177,(vlSelf->rv32e__DOT__reg_file__DOT__regs[19]),32);
    bufp->fullIData(oldp+178,(vlSelf->rv32e__DOT__reg_file__DOT__regs[20]),32);
    bufp->fullIData(oldp+179,(vlSelf->rv32e__DOT__reg_file__DOT__regs[21]),32);
    bufp->fullIData(oldp+180,(vlSelf->rv32e__DOT__reg_file__DOT__regs[22]),32);
    bufp->fullIData(oldp+181,(vlSelf->rv32e__DOT__reg_file__DOT__regs[23]),32);
    bufp->fullIData(oldp+182,(vlSelf->rv32e__DOT__reg_file__DOT__regs[24]),32);
    bufp->fullIData(oldp+183,(vlSelf->rv32e__DOT__reg_file__DOT__regs[25]),32);
    bufp->fullIData(oldp+184,(vlSelf->rv32e__DOT__reg_file__DOT__regs[26]),32);
    bufp->fullIData(oldp+185,(vlSelf->rv32e__DOT__reg_file__DOT__regs[27]),32);
    bufp->fullIData(oldp+186,(vlSelf->rv32e__DOT__reg_file__DOT__regs[28]),32);
    bufp->fullIData(oldp+187,(vlSelf->rv32e__DOT__reg_file__DOT__regs[29]),32);
    bufp->fullIData(oldp+188,(vlSelf->rv32e__DOT__reg_file__DOT__regs[30]),32);
    bufp->fullIData(oldp+189,(vlSelf->rv32e__DOT__reg_file__DOT__regs[31]),32);
    bufp->fullIData(oldp+190,(vlSelf->rv32e__DOT__reg_file__DOT__unnamedblk1__DOT__i),32);
    bufp->fullIData(oldp+191,(vlSelf->rv32e__DOT__wb_stage__DOT__state),32);
    bufp->fullIData(oldp+192,(vlSelf->rv32e__DOT__wb_stage__DOT__next_state),32);
    bufp->fullBit(oldp+193,(vlSelf->clk));
    bufp->fullBit(oldp+194,(vlSelf->reset));
    bufp->fullBit(oldp+195,(vlSelf->rv32e__DOT__if_id_valid));
    bufp->fullBit(oldp+196,(vlSelf->rv32e__DOT__id_ex_valid));
    bufp->fullBit(oldp+197,(vlSelf->rv32e__DOT__ex_mem_valid));
    bufp->fullBit(oldp+198,(vlSelf->rv32e__DOT__mem_wb_valid));
    bufp->fullIData(oldp+199,(0U),32);
    bufp->fullCData(oldp+200,(vlSelf->rv32e__DOT__if_stage__DOT__rresp),2);
    bufp->fullIData(oldp+201,(vlSelf->rv32e__DOT__if_stage__DOT__sram_awaddr),32);
    bufp->fullBit(oldp+202,(vlSelf->rv32e__DOT__if_stage__DOT__sram_awvalid));
    bufp->fullBit(oldp+203,(0U));
    bufp->fullIData(oldp+204,(vlSelf->rv32e__DOT__if_stage__DOT__sram_wdata),32);
    bufp->fullCData(oldp+205,(vlSelf->rv32e__DOT__if_stage__DOT__sram_wstrb),4);
    bufp->fullBit(oldp+206,(vlSelf->rv32e__DOT__if_stage__DOT__sram_wvalid));
    bufp->fullCData(oldp+207,(0U),2);
    bufp->fullBit(oldp+208,(vlSelf->rv32e__DOT__if_stage__DOT__sram_bready));
    bufp->fullIData(oldp+209,(0x20U),32);
    bufp->fullIData(oldp+210,(3U),32);
    bufp->fullCData(oldp+211,(2U),2);
}
