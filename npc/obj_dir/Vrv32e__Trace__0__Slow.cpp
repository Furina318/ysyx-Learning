...
VL_ATTR_COLD void Vrv32e___024root__trace_init_sub__TOP__0(Vrv32e___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+108,"ex_lsu_pc", false,-1, 31,0);
    tracep->declBus(c+109,"ex_lsu_inst", false,-1, 31,0);
    tracep->declBit(c+110,"ex_lsu_valid", false,-1);
    tracep->declBit(c+158,"lsu_ex_ready", false,-1);
    tracep->declBus(c+111,"ex_lsu_src2", false,-1, 31,0);
    tracep->declBit(c+112,"ex_lsu_RegWrite", false,-1);
    tracep->declBus(c+113,"ex_lsu_rd", false,-1, 4,0);
    tracep->declBit(c+114,"ex_lsu_MemRead", false,-1);
    tracep->declBit(c+115,"ex_lsu_MemWrite", false,-1);
    tracep->declBus(c+116,"ex_lsu_MemLen", false,-1, 2,0);
    ...
    tracep->declBit(c+118,"ex_lsu_csr", false,-1);
    tracep->declBit(c+119,"ex_lsu_csr_wen1", false,-1);
    tracep->declBit(c+120,"ex_lsu_csr_wen2", false,-1);
    tracep->declBus(c+121,"ex_lsu_csr_wr_addr1", false,-1, 11,0);
    tracep->declBus(c+122,"ex_lsu_csr_wr_addr2", false,-1, 11,0);
    ...
    tracep->declBus(c+129,"ex_lsu_opcode", false,-1, 6,0);
    tracep->declBus(c+46,"lsu_wb_pc", false,-1, 31,0);
    tracep->declBus(c+47,"lsu_wb_inst", false,-1, 31,0);
    tracep->declBit(c+48,"lsu_wb_valid", false,-1);
    tracep->declBit(c+187,"wb_lsu_ready", false,-1);
    tracep->declBit(c+49,"lsu_wb_RegWrite", false,-1);
    tracep->declBus(c+50,"lsu_wb_rd", false,-1, 4,0);
    tracep->declBus(c+51,"lsu_wb_write_rd_data", false,-1, 31,0);
    tracep->declBus(c+52,"lsu_wb_csr_wr_data1", false,-1, 31,0);
    tracep->declBus(c+53,"lsu_wb_csr_wr_data2", false,-1, 31,0);
    tracep->declBus(c+54,"lsu_wb_csr_wr_addr1", false,-1, 11,0);
    tracep->declBus(c+55,"lsu_wb_csr_wr_addr2", false,-1, 11,0);
    tracep->declBit(c+56,"lsu_wb_csr_wen1", false,-1);
    tracep->declBit(c+57,"lsu_wb_csr_wen2", false,-1);
    tracep->declBit(c+58,"lsu_wb_flush", false,-1);
    ...
    tracep->declBus(c+62,"lsu_ex_forward_rd", false,-1, 4,0);
    tracep->declBit(c+63,"lsu_ex_forward_RegWrite", false,-1);
    tracep->declBit(c+64,"lsu_ex_forward_MemRead", false,-1);
    tracep->declBit(c+130,"ex_lsu_forward_las", false,-1);
    ...
    tracep->declBit(c+135,"id_valid", false,-1);
    tracep->declBit(c+164,"ex_ready", false,-1);
    tracep->declBit(c+158,"lsu_ready", false,-1);
    tracep->declBit(c+110,"ex_lsu_valid", false,-1);
    tracep->declBus(c+138,"id_wb_rs1", false,-1, 4,0);
    tracep->declBus(c+39,"id_wb_rs2", false,-1, 4,0);
    tracep->declBus(c+62,"lsu_ex_forward_rd", false,-1, 4,0);
    tracep->declBit(c+63,"lsu_ex_forward_RegWrite", false,-1);
    tracep->declBit(c+64,"lsu_ex_forward_MemRead", false,-1);
    tracep->declBus(c+51,"lsu_wb_wdata", false,-1, 31,0);
    tracep->declBus(c+50,"lsu_wb_rd", false,-1, 4,0);
    tracep->declBit(c+49,"lsu_wb_RegWrite", false,-1);
    tracep->declBit(c+48,"lsu_wb_valid", false,-1);
    tracep->declBit(c+130,"ex_lsu_forward_las", false,-1);
    ...
    tracep->declBus(c+72,"read_lsu_data", false,-1, 31,0);
...
VL_ATTR_COLD void Vrv32e___024root__trace_full_sub_0(Vrv32e___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+46,(vlSelf->rv32e__DOT__lsu_wb_pc),32);
    bufp->fullIData(oldp+47,(vlSelf->rv32e__DOT__lsu_wb_inst),32);
    bufp->fullBit(oldp+48,(vlSelf->rv32e__DOT__lsu_wb_valid));
    bufp->fullBit(oldp+49,(vlSelf->rv32e__DOT__lsu_wb_RegWrite));
    bufp->fullCData(oldp+50,(vlSelf->rv32e__DOT__lsu_wb_rd),5);
    bufp->fullIData(oldp+51,(vlSelf->rv32e__DOT__lsu_wb_write_rd_data),32);
    bufp->fullIData(oldp+52,(vlSelf->rv32e__DOT__lsu_wb_csr_wr_data1),32);
    bufp->fullIData(oldp+53,(vlSelf->rv32e__DOT__lsu_wb_csr_wr_data2),32);
    bufp->fullSData(oldp+54,(vlSelf->rv32e__DOT__lsu_wb_csr_wr_addr1),12);
    bufp->fullSData(oldp+55,(vlSelf->rv32e__DOT__lsu_wb_csr_wr_addr2),12);
    bufp->fullBit(oldp+56,(vlSelf->rv32e__DOT__lsu_wb_csr_wen1));
    bufp->fullBit(oldp+57,(vlSelf->rv32e__DOT__lsu_wb_csr_wen2));
    bufp->fullBit(oldp+58,(vlSelf->rv32e__DOT__lsu_wb_flush));
    ...
    bufp->fullCData(oldp+62,(vlSelf->rv32e__DOT__lsu__DOT__l_rd_addr),5);
    bufp->fullBit(oldp+63,(vlSelf->rv32e__DOT__lsu__DOT__l_rd_en));
    bufp->fullBit(oldp+64,(vlSelf->rv32e__DOT__lsu__DOT__l_load));
    bufp->fullBit(oldp+65,(vlSelf->rv32e__DOT__exu__DOT__ex_flush_condition));
    bufp->fullIData(oldp+66,(vlSelf->rv32e__DOT__lsu__DOT__l_inst),32);
    bufp->fullIData(oldp+67,(vlSelf->rv32e__DOT__lsu__DOT__l_pc),32);
    bufp->fullCData(oldp+68,(vlSelf->rv32e__DOT__lsu__DOT__l_MemLen),3);
    bufp->fullCData(oldp+69,(vlSelf->rv32e__DOT__lsu__DOT__l_opcode),7);
    bufp->fullBit(oldp+70,(vlSelf->rv32e__DOT__lsu__DOT__read_valid));
    bufp->fullBit(oldp+71,(vlSelf->rv32e__DOT__lsu__DOT__write_valid));
    bufp->fullIData(oldp+72,(vlSelf->rv32e__DOT__lsu__DOT__read_lsu_data),32);
    bufp->fullIData(oldp+73,(((0U == (IData)(vlSelf->rv32e__DOT__lsu__DOT__l_MemLen))
    ...
    bufp->fullIData(oldp+108,(vlSelf->rv32e__DOT__ex_lsu_pc),32);
    bufp->fullIData(oldp+109,(vlSelf->rv32e__DOT__ex_lsu_inst),32);
    bufp->fullBit(oldp+110,(vlSelf->rv32e__DOT__ex_lsu_valid));
    bufp->fullIData(oldp+111,(vlSelf->rv32e__DOT__ex_lsu_src2),32);
    bufp->fullBit(oldp+112,(vlSelf->rv32e__DOT__ex_lsu_RegWrite));
    bufp->fullCData(oldp+113,(vlSelf->rv32e__DOT__ex_lsu_rd),5);
    bufp->fullBit(oldp+114,(vlSelf->rv32e__DOT__ex_lsu_MemRead));
    bufp->fullBit(oldp+115,(vlSelf->rv32e__DOT__ex_lsu_MemWrite));
    bufp->fullCData(oldp+116,(vlSelf->rv32e__DOT__ex_lsu_MemLen),3);
    bufp->fullIData(oldp+117,(vlSelf->rv32e__DOT__ex_lsu_process_result),32);
    bufp->fullBit(oldp+118,(vlSelf->rv32e__DOT__ex_lsu_csr));
    bufp->fullBit(oldp+119,(vlSelf->rv32e__DOT__ex_lsu_csr_wen1));
    bufp->fullBit(oldp+120,(vlSelf->rv32e__DOT__ex_lsu_csr_wen2));
    bufp->fullSData(oldp+121,(vlSelf->rv32e__DOT__ex_lsu_csr_wr_addr1),12);
    bufp->fullSData(oldp+122,(vlSelf->rv32e__DOT__ex_lsu_csr_wr_addr2),12);
    bufp->fullIData(oldp+123,(vlSelf->rv32e__DOT__ex_lsu_csr_wr_data1),32);
    bufp->fullIData(oldp+124,(vlSelf->rv32e__DOT__ex_lsu_csr_wr_data2),32);
    bufp->fullIData(oldp+125,(vlSelf->rv32e__DOT__ex_lsu_csr_rdata),32);
    bufp->fullBit(oldp+126,(vlSelf->rv32e__DOT__ex_lsu_csr_ecall));
    bufp->fullBit(oldp+127,(vlSelf->rv32e__DOT__ex_lsu_csr_mret));
    bufp->fullIData(oldp+128,(vlSelf->rv32e__DOT__ex_lsu_imm),32);
    bufp->fullCData(oldp+129,(vlSelf->rv32e__DOT__ex_lsu_opcode),7);
    bufp->fullBit(oldp+130,(vlSelf->rv32e__DOT__ex_lsu_forward_las));
    bufp->fullCData(oldp+131,(((1U == (IData)(vlSelf->rv32e__DOT__ex_lsu_MemLen))
    ...
    bufp->fullBit(oldp+158,(vlSelf->rv32e__DOT__lsu_ex_ready));
