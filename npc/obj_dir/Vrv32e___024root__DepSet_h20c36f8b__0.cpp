...
VL_INLINE_OPT void Vrv32e___024root___nba_sequent__TOP__0(Vrv32e___024root* vlSelf) {
    ...
    // Init
    CData/*4:0*/ __Vdlyvdim0__rv32e__DOT__reg_file__DOT__regs__v0;
    __Vdlyvdim0__rv32e__DOT__reg_file__DOT__regs__v0 = 0;
    IData/*31:0*/ __Vdlyvval__rv32e__DOT__reg_file__DOT__regs__v0;
    __Vdlyvval__rv32e__DOT__reg_file__DOT__regs__v0 = 0;
    CData/*0:0*/ __Vdlyvset__rv32e__DOT__reg_file__DOT__regs__v0;
    __Vdlyvset__rv32e__DOT__reg_file__DOT__regs__v0 = 0;
    // Body
    VL_WRITEF("\033[35m[REG][READ]: rs1=%2# rs1_val=0x%x | rs2=%2# rs2_val=0x%x\033[0m\n",
              5,vlSelf->rv32e__DOT__id_rs1,32,vlSelf->rv32e__DOT__rs1_val,
              5,(IData)(vlSelf->rv32e__DOT__id_rs2),
    ...
    if (VL_UNLIKELY(vlSelf->rv32e__DOT__stall)) {
        VL_WRITEF("\033[32m         [STALL]\346\232\202\345\201\234!!!\033[0m\n");
    }
    if (VL_UNLIKELY((((IData)(vlSelf->rv32e__DOT__ex_mem_MemRead) 
                      | (IData)(vlSelf->rv32e__DOT__ex_mem_MemWrite)) 
                     & (IData)(vlSelf->rv32e__DOT__if_ready)))) {
        VL_WRITEF("\033[32m         [STRUCT]IF\345\222\214MEM\350\256\277\351\227\256\345\206\262\347\252\201,\347\273\223\346\236\204\345\206\222\351\231\251\350\247\246\345\217\221\033[0m\n");
    }
    if (VL_UNLIKELY(((IData)(vlSelf->rv32e__DOT__RegWrite_wb) 
                     & (0U != (IData)(vlSelf->rv32e__DOT__rd_wb))))) {
        VL_WRITEF("\033[35m[REG][WRITE]: regs[%2#] = 0x%x\033[0m\n",
                  5,vlSelf->rv32e__DOT__rd_wb,32,vlSelf->rv32e__DOT__wb_data);
        __Vdlyvval__rv32e__DOT__reg_file__DOT__regs__v0 
            = vlSelf->rv32e__DOT__wb_data;
        __Vdlyvset__rv32e__DOT__reg_file__DOT__regs__v0 = 1U;
        __Vdlyvdim0__rv32e__DOT__reg_file__DOT__regs__v0 
            = vlSelf->rv32e__DOT__rd_wb;
    }
    if (__Vdlyvset__rv32e__DOT__reg_file__DOT__regs__v0) {
        vlSelf->rv32e__DOT__reg_file__DOT__regs[__Vdlyvdim0__rv32e__DOT__reg_file__DOT__regs__v0] 
            = __Vdlyvval__rv32e__DOT__reg_file__DOT__regs__v0;
    }
}
...
VL_INLINE_OPT void Vrv32e___024root___nba_sequent__TOP__1(Vrv32e___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (((IData)(vlSelf->rv32e__DOT__ex_valid) 
            ...
            vlSelf->rv32e__DOT__ex_mem_valid = vlSelf->rv32e__DOT__ex_valid;
        }
    }
    if (vlSelf->reset) {
        vlSelf->rv32e__DOT__id_ex_alu_op = 0U;
        vlSelf->rv32e__DOT__id_ex_func7 = 0U;
    } else if (((IData)(vlSelf->rv32e__DOT__flush) 
    ...
    if (vlSelf->reset) {
        ...
        if ((0U == vlSelf->rv32e__DOT__ex_stage__DOT__state)) {
            ...
            if (vlSelf->rv32e__DOT__id_valid) {
                ...
                vlSelf->rv32e__DOT__ex_alu_zero = (0U 
                                                   == vlSelf->rv32e__DOT__ex_alu_result);
                vlSelf->rv32e__DOT__ex_jal_target = 
                    ((vlSelf->rv32e__DOT__id_ex_pc 
                      - (IData)(4U)) + vlSelf->rv32e__DOT__id_ex_imm);
                vlSelf->rv32e__DOT__ex_jalr_target 
                    = (0xfffffffeU & (vlSelf->rv32e__DOT__rs1_val 
                                      + vlSelf->rv32e__DOT__id_ex_imm));
                vlSelf->rv32e__DOT__ex_is_jal = (0x6fU 
                                                 == (IData)(vlSelf->rv32e__DOT__id_ex_opcode));
                vlSelf->rv32e__DOT__ex_is_jalr = ((0x67U 
                                                   == (IData)(vlSelf->rv32e__DOT__id_ex_opcode)) 
                                                  & (0U 
                                                   ...
                                                   ((6U 
                                                    ...
                                                    VL_LTS_III(32, vlSelf->rv32e__DOT__rs1_val, 
                                                               (((0xcU 
                                                                 ...
                                                                 ? vlSelf->rv32e__DOT__rs2_val
                                                                 : vlSelf->rv32e__DOT__id_ex_imm))));
                vlSelf->rv32e__DOT__ex_take_branch 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        ...
        if (((IData)(vlSelf->rv32e__DOT__ex_valid) 
             & (IData)(vlSelf->rv32e__DOT__mem_ready))) {
            vlSelf->rv32e__DOT__ex_mem_is_ebreak = vlSelf->rv32e__DOT__id_ex_is_ebreak;
        }
        if (((IData)(vlSelf->rv32e__DOT__mem_valid) 
             & (IData)(vlSelf->rv32e__DOT__wb_ready))) {
            vlSelf->rv32e__DOT__mem_wb_valid = vlSelf->rv32e__DOT__mem_valid;
            vlSelf->rv32e__DOT__mem_wb_is_ebreak = vlSelf->rv32e__DOT__ex_mem_is_ebreak;
        }
    }
    if (vlSelf->reset) {
        ...
        if (((IData)(vlSelf->rv32e__DOT__ex_valid) 
             & (IData)(vlSelf->rv32e__DOT__mem_ready))) {
            vlSelf->rv32e__DOT__ex_mem_alu_less = vlSelf->rv32e__DOT__ex_alu_less;
            vlSelf->rv32e__DOT__ex_mem_alu_zero = vlSelf->rv32e__DOT__ex_alu_zero;
        ...
        if (((IData)(vlSelf->rv32e__DOT__mem_valid) 
             & (IData)(vlSelf->rv32e__DOT__wb_ready))) {
            vlSelf->rv32e__DOT__mem_wb_alu_less = vlSelf->rv32e__DOT__ex_mem_alu_less;
            vlSelf->rv32e__DOT__mem_wb_alu_zero = vlSelf->rv32e__DOT__ex_mem_alu_zero;
            vlSelf->rv32e__DOT__mem_wb_alu_result = vlSelf->rv32e__DOT__ex_mem_alu_result;
            ...
            vlSelf->rv32e__DOT__mem_wb_RegWrite = vlSelf->rv32e__DOT__ex_mem_RegWrite;
        ...
        if (((IData)(vlSelf->rv32e__DOT__flush) | (IData)(vlSelf->rv32e__DOT__stall))) {
            ...
            vlSelf->rv32e__DOT__id_ex_rs1_val = 0U;
                    ...
                    & (IData)(vlSelf->rv32e__DOT__ex_ready))) {
            vlSelf->rv32e__DOT__id_ex_rs2_val = ((((IData)(vlSelf->rv32e__DOT__ex_mem_rd) 
                                                 ...
                                                 ((((IData)(vlSelf->rv32e__DOT__id_rs2) 
                                                   ...
                                                   ? vlSelf->rv32e__DOT__wb_data
                                                   : vlSelf->rv32e__DOT__rs2_val));
            vlSelf->rv32e__DOT__id_ex_rs1_val = ((((IData)(vlSelf->rv32e__DOT__ex_mem_rd) 
        ...
        if (((IData)(vlSelf->rv32e__DOT__ex_valid) 
             & (IData)(vlSelf->rv32e__DOT__mem_ready))) {
            vlSelf->rv32e__DOT__ex_mem_rs2_val = vlSelf->rv32e__DOT__id_ex_rs2_val;
            vlSelf->rv32e__DOT__ex_mem_rs1_val = vlSelf->rv32e__DOT__id_ex_rs1_val;
        }
        vlSelf->rv32e__DOT__wb_stage__DOT__state = vlSelf->rv32e__DOT__wb_stage__DOT__next_state;
        if (((IData)(vlSelf->rv32e__DOT__mem_valid) 
             & (IData)(vlSelf->rv32e__DOT__wb_ready))) {
            vlSelf->rv32e__DOT__mem_wb_rs2_val = vlSelf->rv32e__DOT__ex_mem_rs2_val;
            vlSelf->rv32e__DOT__mem_wb_rs1_val = vlSelf->rv32e__DOT__ex_mem_rs1_val;
        }
        if ((0U == vlSelf->rv32e__DOT__wb_stage__DOT__state)) {
            vlSelf->rv32e__DOT__wb_ready = 1U;
            vlSelf->rv32e__DOT__wb_valid = 0U;
            vlSelf->rv32e__DOT__RegWrite_wb = 0U;
            vlSelf->rv32e__DOT__rd_wb = 0U;
        ...
        if (vlSelf->rv32e__DOT__flush) {
            ...
            vlSelf->rv32e__DOT__if_id_instr = 0U;
        } else if ((((~ (IData)(vlSelf->rv32e__DOT__stall)) 
        ...
        if (((IData)(vlSelf->rv32e__DOT__ex_valid) 
            ...
            vlSelf->rv32e__DOT__ex_mem_instr = vlSelf->rv32e__DOT__id_ex_instr;
        }
        if (((IData)(vlSelf->rv32e__DOT__mem_valid) 
             & (IData)(vlSelf->rv32e__DOT__wb_ready))) {
            vlSelf->rv32e__DOT__mem_wb_pc = ((IData)(vlSelf->rv32e__DOT__flush)
                                              ? (vlSelf->rv32e__DOT__ex_mem_pc 
                                                 - (IData)(4U))
                                              : vlSelf->rv32e__DOT__ex_mem_pc);
            vlSelf->rv32e__DOT__mem_wb_instr = vlSelf->rv32e__DOT__ex_mem_instr;
        }
    }
    ...
    if (vlSelf->reset) {
        ...
        if (((IData)(vlSelf->rv32e__DOT__mem_valid) 
             & (IData)(vlSelf->rv32e__DOT__wb_ready))) {
            vlSelf->rv32e__DOT__mem_wb_data_out = vlSelf->rv32e__DOT__mem_data_out;
        }
        ...
        if ((0U == vlSelf->rv32e__DOT__if_stage__DOT__state)) {
            ...
            if (vlSelf->rv32e__DOT__struct_hazard) {
    ...
    vlSelf->rv32e__DOT__branch_target = ((IData)(vlSelf->rv32e__DOT__ex_is_jalr)
                                          ? vlSelf->rv32e__DOT__ex_jalr_target
                                          : vlSelf->rv32e__DOT__ex_jal_target);
    vlSelf->rv32e__DOT____Vcellinp__if_stage__pc_src 
        = ((IData)(vlSelf->rv32e__DOT__ex_is_jal) | 
           ((IData)(vlSelf->rv32e__DOT__ex_is_jalr) 
            | (IData)(vlSelf->rv32e__DOT__ex_take_branch)));
    ...
    vlSelf->rv32e__DOT__struct_hazard = (((IData)(vlSelf->rv32e__DOT__ex_mem_MemRead) 
                                          | (IData)(vlSelf->rv32e__DOT__ex_mem_MemWrite)) 
                                         & (IData)(vlSelf->rv32e__DOT__if_ready));
    ...
    if (vlSelf->reset) {
        ...
        if ((0U == vlSelf->rv32e__DOT__mem_stage__DOT__mem_sram_inst__DOT__sram_state)) {
            ...
            if ((0U < (IData)(vlSelf->rv32e__DOT__mem_stage__DOT__mem_sram_inst__DOT__delay_counter))) {
                ...
                if (VL_UNLIKELY(vlSelf->rv32e__DOT__mem_stage__DOT__mem_sram_inst__DOT__addr_valid)) {
                    ...
                    VL_WRITEF("\033[37m[MEM][READ]:  form 0x%x read 0x%x\033[0m\n",
                              32,vlSelf->rv32e__DOT__mem_stage__DOT__mem_sram_inst__DOT__araddr_reg,
                              32,vlSelf->rv32e__DOT__mem_stage__DOT__mem_sram_inst__DOT__rdata_reg);
                    vlSelf->rv32e__DOT__mem_stage__DOT__sram_rresp = 0U;
                } else {
                    __Vdly__rv32e__DOT__mem_stage__DOT__mem_sram_inst__DOT__rdata_reg = 0U;
            ...
            if (((IData)(vlSelf->rv32e__DOT__mem_stage__DOT__sram_wvalid) 
                ...
                if (VL_UNLIKELY(vlSelf->rv32e__DOT__mem_stage__DOT__mem_sram_inst__DOT__addr_valid)) {
                    ...
                    VL_WRITEF("\033[37m[MEM][WRITE]: write 0x%x(wstrb=%b) at 0x%x\033[0m\n",
                              32,vlSelf->rv32e__DOT__mem_stage__DOT__mem_sram_inst__DOT__wdata_reg,
                              4,(IData)(vlSelf->rv32e__DOT__mem_stage__DOT__mem_sram_inst__DOT__wstrb_reg),
                              32,vlSelf->rv32e__DOT__mem_stage__DOT__mem_sram_inst__DOT__awaddr_reg);
                    vlSelf->rv32e__DOT__mem_stage__DOT__sram_bresp = 0U;
                } else {
...
VL_INLINE_OPT void Vrv32e___024root___nba_comb__TOP__0(Vrv32e___024root* vlSelf) {
    ...
    // Body
    vlSelf->rv32e__DOT__rs2_val = ((0U == (IData)(vlSelf->rv32e__DOT__id_rs2))
                                    ? 0U : vlSelf->rv32e__DOT__reg_file__DOT__regs
                                   [vlSelf->rv32e__DOT__id_rs2]);
    vlSelf->rv32e__DOT__rs1_val = ((0U == (IData)(vlSelf->rv32e__DOT__id_rs1))
                                    ? 0U : vlSelf->rv32e__DOT__reg_file__DOT__regs
                                   [vlSelf->rv32e__DOT__id_rs1]);
    VL_WRITEF("\033[32m[EX]: state = %11d | rs1_val=0x%x | imm=0x%x | alu_result=0x%x\033[0m\n",
              32,vlSelf->rv32e__DOT__ex_stage__DOT__state,
              32,vlSelf->rv32e__DOT__rs1_val,32,vlSelf->rv32e__DOT__id_ex_imm,
              32,vlSelf->rv32e__DOT__ex_alu_result);
}
