...
VL_INLINE_OPT void Vrv32e___024root___nba_sequent__TOP__0(Vrv32e___024root* vlSelf) {
    ...
    // Init
    IData/*31:0*/ __Vfunc_rv32e__DOT__lsu__DOT__pmem_read__2__Vfuncout;
    __Vfunc_rv32e__DOT__lsu__DOT__pmem_read__2__Vfuncout = 0;
    IData/*31:0*/ __Vfunc_rv32e__DOT__lsu__DOT__pmem_read__3__Vfuncout;
    __Vfunc_rv32e__DOT__lsu__DOT__pmem_read__3__Vfuncout = 0;
    IData/*31:0*/ __Vfunc_rv32e__DOT__lsu__DOT__pmem_read__4__Vfuncout;
    __Vfunc_rv32e__DOT__lsu__DOT__pmem_read__4__Vfuncout = 0;
    IData/*31:0*/ __Vfunc_rv32e__DOT__lsu__DOT__pmem_read__5__Vfuncout;
    __Vfunc_rv32e__DOT__lsu__DOT__pmem_read__5__Vfuncout = 0;
    ...
    if (vlSelf->reset) {
    ...
    } else if ((((IData)(vlSelf->rv32e__DOT__lsu_wb_valid) 
        ...
        if (VL_UNLIKELY((vlSelf->rv32e__DOT__wbu__DOT__regs
            ...
            VL_WRITEF("[WBU] Reg x%2# changed to 0x%x\n",
                      5,vlSelf->rv32e__DOT__lsu_wb_rd,
                      32,vlSelf->rv32e__DOT__lsu_wb_write_rd_data);
        }
    ...
    if (vlSelf->reset) {
    ...
    } else if (VL_UNLIKELY((((IData)(vlSelf->rv32e__DOT__ex_lsu_valid) 
                             & (IData)(vlSelf->rv32e__DOT__lsu_ex_ready)) 
                            & ((IData)(vlSelf->rv32e__DOT__ex_lsu_MemRead) 
                               & (~ (IData)(vlSelf->rv32e__DOT__ex_lsu_MemWrite)))))) {
        if ((4U & (IData)(vlSelf->rv32e__DOT__lsu__DOT__l_MemLen))) {
            if ((2U & (IData)(vlSelf->rv32e__DOT__lsu__DOT__l_MemLen))) {
                vlSelf->rv32e__DOT__lsu__DOT__read_lsu_data = 0U;
            } else if ((1U & (IData)(vlSelf->rv32e__DOT__lsu__DOT__l_MemLen))) {
                vlSelf->rv32e__DOT__lsu__DOT__read_lsu_data = 0U;
            } else {
                Vrv32e___024root____Vdpiimwrap_rv32e__DOT__ifu__DOT__pmem_read_TOP(vlSelf->rv32e__DOT__ex_lsu_process_result, 1U, __Vfunc_rv32e__DOT__lsu__DOT__pmem_read__2__Vfuncout);
                vlSelf->rv32e__DOT__lsu__DOT__read_lsu_data 
                    = __Vfunc_rv32e__DOT__lsu__DOT__pmem_read__2__Vfuncout;
            }
        } else if ((2U & (IData)(vlSelf->rv32e__DOT__lsu__DOT__l_MemLen))) {
            if ((1U & (IData)(vlSelf->rv32e__DOT__lsu__DOT__l_MemLen))) {
                Vrv32e___024root____Vdpiimwrap_rv32e__DOT__ifu__DOT__pmem_read_TOP(vlSelf->rv32e__DOT__ex_lsu_process_result, 2U, __Vfunc_rv32e__DOT__lsu__DOT__pmem_read__3__Vfuncout);
                vlSelf->rv32e__DOT__lsu__DOT__read_lsu_data 
                    = __Vfunc_rv32e__DOT__lsu__DOT__pmem_read__3__Vfuncout;
            } else {
                Vrv32e___024root____Vdpiimwrap_rv32e__DOT__ifu__DOT__pmem_read_TOP(vlSelf->rv32e__DOT__ex_lsu_process_result, 4U, __Vfunc_rv32e__DOT__lsu__DOT__pmem_read__4__Vfuncout);
                vlSelf->rv32e__DOT__lsu__DOT__read_lsu_data 
                    = __Vfunc_rv32e__DOT__lsu__DOT__pmem_read__4__Vfuncout;
            }
        } else if ((1U & (IData)(vlSelf->rv32e__DOT__lsu__DOT__l_MemLen))) {
            Vrv32e___024root____Vdpiimwrap_rv32e__DOT__ifu__DOT__pmem_read_TOP(vlSelf->rv32e__DOT__ex_lsu_process_result, 2U, __Vfunc_rv32e__DOT__lsu__DOT__pmem_read__5__Vfuncout);
            vlSelf->rv32e__DOT__lsu__DOT__read_lsu_data 
                = __Vfunc_rv32e__DOT__lsu__DOT__pmem_read__5__Vfuncout;
        } else {
        ...
        VL_WRITEF("read addr: %x, data: %x, MemLen: %b, opcode: %b\n",
                  ...
                  32,vlSelf->rv32e__DOT__lsu__DOT__read_lsu_data,
                  3,(IData)(vlSelf->rv32e__DOT__lsu__DOT__l_MemLen),
                  7,vlSelf->rv32e__DOT__lsu__DOT__l_opcode);
    } else {
        vlSelf->rv32e__DOT__lsu__DOT__read_valid = 0U;
    }
    if (vlSelf->reset) {
        ...
        } else if ((2U == (IData)(vlSelf->rv32e__DOT__ex_lsu_MemLen))) {
        ...
        VL_WRITEF("write addr: %x, data: %x\n",32,vlSelf->rv32e__DOT__ex_lsu_process_result,
                  32,vlSelf->rv32e__DOT__ex_lsu_src2);
    } else {
        vlSelf->rv32e__DOT__lsu__DOT__write_valid = 0U;
    }
...
VL_INLINE_OPT void Vrv32e___024root___nba_comb__TOP__0(Vrv32e___024root* vlSelf) {
    ...
    vlSelf->rv32e__DOT__exu__DOT____VdfgTmp_hcfc89bc9__0 
        = ((IData)(vlSelf->rv32e__DOT__exu__DOT____VdfgTmp_h69af1a50__0) 
           & ((IData)(vlSelf->rv32e__DOT__exu__DOT____VdfgTmp_he5bf04e5__0) 
              & (IData)(vlSelf->rv32e__DOT__ex_lsu_valid)));
    vlSelf->rv32e__DOT__exu__DOT____VdfgTmp_h9a38ce48__0 
    ...
    vlSelf->rv32e__DOT__exu__DOT____VdfgTmp_h93a4b40d__0 
        = ((IData)(vlSelf->rv32e__DOT__exu__DOT____VdfgTmp_h804502ec__0) 
           & ((0U != (IData)(vlSelf->rv32e__DOT__ex_lsu_rd)) 
              & (IData)(vlSelf->rv32e__DOT__exu__DOT____VdfgTmp_hc613623f__0)));
    vlSelf->rv32e__DOT__exu__DOT__src2 = ((IData)(vlSelf->rv32e__DOT__exu__DOT____VdfgTmp_hcfc89bc9__0)
                                           ...
                                           : (((IData)(vlSelf->rv32e__DOT__exu__DOT____VdfgTmp_h3556a05f__0) 
                                               | (IData)(vlSelf->rv32e__DOT__exu__DOT____VdfgTmp_h9a38ce48__0))
                                               ? vlSelf->rv32e__DOT__lsu_wb_write_rd_data
                                               : ((0U 
                                                   == (IData)(vlSelf->rv32e__DOT__id_wb_rs2))
                                                   ? 0U
    ...
    vlSelf->rv32e__DOT__exu__DOT__load_use_flag = (
                                                   ...
                                                   | ((((IData)(vlSelf->rv32e__DOT__exu__DOT____VdfgTmp_hb53dc38f__0) 
                                                        & ((IData)(vlSelf->rv32e__DOT__id_wb_rs2) 
                                                           == (IData)(vlSelf->rv32e__DOT__lsu__DOT__l_rd_addr))) 
                                                       << 2U) 
                                                      | (((IData)(vlSelf->rv32e__DOT__exu__DOT____VdfgTmp_h93a4b40d__0) 
                                                          << 1U) 
                                                         | (IData)(vlSelf->rv32e__DOT__exu__DOT____VdfgTmp_h9a38ce48__0))));
