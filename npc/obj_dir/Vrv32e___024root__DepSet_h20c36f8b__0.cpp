...
VL_INLINE_OPT void Vrv32e___024root___nba_sequent__TOP__0(Vrv32e___024root* vlSelf) {
    ...
    // Body
    VL_WRITEF("\033[31m[ID]: state=%11d | id_ready=%b | id_valid=%b\033[0m\n\033[35m[IF] PC=0x%x\033[0m\n\033[35m[IF] state=%11d | pc=0x%x | instr=0x%x | if_valid=%b | if_ready=%b\033[0m\n\033[33m[MEM] state=%11d | addr=0x%x | sram_addr=0x%x | mem_ready=%b | mem_valid=%b\033[0m\n",
              32,vlSelf->rv32e__DOT__id_stage__DOT__state,
              1,(IData)(vlSelf->rv32e__DOT__id_ready),
              1,vlSelf->rv32e__DOT__id_valid,32,vlSelf->rv32e__DOT__if_pc,
              ...
              1,vlSelf->rv32e__DOT__if_ready,32,vlSelf->rv32e__DOT__mem_stage__DOT__state,
              32,vlSelf->rv32e__DOT__ex_mem_alu_result,
              32,vlSelf->rv32e__DOT__mem_stage__DOT__sram_araddr,
              1,(IData)(vlSelf->rv32e__DOT__mem_ready),
              1,vlSelf->rv32e__DOT__mem_valid);
}
...
VL_INLINE_OPT void Vrv32e___024root___nba_sequent__TOP__1(Vrv32e___024root* vlSelf) {
    ...
    if (vlSelf->reset) {
        ...
        if ((0U == vlSelf->rv32e__DOT__ex_stage__DOT__state)) {
            vlSelf->rv32e__DOT__ex_ready = 1U;
            vlSelf->rv32e__DOT__ex_valid = 0U;
            if (vlSelf->rv32e__DOT__id_ex_valid) {
                                                   ...
                                                   & (((0xcU 
                                                       ...
                                                       | (0x18U 
                                                          ...
                                                          (0x1fU 
                                                           & ((IData)(vlSelf->rv32e__DOT__id_ex_opcode) 
                                                              >> 2U))))
                                                       ? vlSelf->rv32e__DOT__ex_rs2_val
                                                       : vlSelf->rv32e__DOT__id_ex_imm)))
                                            : VL_SHIFTRS_III(32,32,5, vlSelf->rv32e__DOT__ex_rs1_val, 
                                                             (0x1fU 
                                                              & (((0xcU 
                                                                   == 
                                                                   (0x1fU 
                      ...
                      : ((4U & (IData)(vlSelf->rv32e__DOT__id_ex_alu_op))
                          ? ((2U & (IData)(vlSelf->rv32e__DOT__id_ex_alu_op))
                              ? ((1U & (IData)(vlSelf->rv32e__DOT__id_ex_alu_op))
                                  ? (VL_LTS_III(32, vlSelf->rv32e__DOT__ex_rs1_val, 
                                                (((0xcU 
                                                   == 
                                                   (0x1fU 
                                                    & ((IData)(vlSelf->rv32e__DOT__id_ex_opcode) 
    ...
    if (vlSelf->reset) {
        ...
        if ((0U == vlSelf->rv32e__DOT__id_stage__DOT__state)) {
            ...
            if (vlSelf->rv32e__DOT__if_id_valid) {
                ...
                vlSelf->rv32e__DOT__id_stage__DOT__next_state 
                    = ((IData)(vlSelf->rv32e__DOT____Vcellinp__id_stage__ex_ready)
                        ? 1U : 0U);
                    ...
                    if (VL_LIKELY((8U & (IData)(vlSelf->rv32e__DOT__id_stage__DOT__get_opcode)))) {
                        if ((4U & (IData)(vlSelf->rv32e__DOT__id_stage__DOT__get_opcode))) {
                            if (VL_UNLIKELY((2U & (IData)(vlSelf->rv32e__DOT__id_stage__DOT__get_opcode)))) {
                                ...
                                Vrv32e___024root____Vdpiimwrap_rv32e__DOT__id_stage__DOT__ebreak_TOP(1U, vlSelf->rv32e__DOT__if_id_instr);
                            }
    ...
    if (vlSelf->reset) {
        ...
        vlSelf->rv32e__DOT__wb_jal_target = 0U;
        vlSelf->rv32e__DOT__wb_jalr_target = 0U;
        vlSelf->rv32e__DOT__wb_is_jal = 0U;
        vlSelf->rv32e__DOT__wb_is_jalr = 0U;
        vlSelf->rv32e__DOT__wb_take_branch = 0U;
        ...
        if ((0U == vlSelf->rv32e__DOT__wb_stage__DOT__state)) {
            ...
            if (vlSelf->rv32e__DOT__mem_wb_valid) {
                ...
                vlSelf->rv32e__DOT__wb_jalr_target 
                    = (0xfffffffeU & (vlSelf->rv32e__DOT__id_rs1_val 
                                      + vlSelf->rv32e__DOT__mem_wb_imm));
                ...
                vlSelf->rv32e__DOT__wb_is_jalr = ((0x67U 
                                                   == (IData)(vlSelf->rv32e__DOT__mem_wb_opcode)) 
                                                  & (0U 
                                                     == (IData)(vlSelf->rv32e__DOT__mem_wb_func3)));
                vlSelf->rv32e__DOT__wb_take_branch 
                    = ((0x63U == (IData)(vlSelf->rv32e__DOT__mem_wb_opcode)) 
                       & (((((((1U == (IData)(vlSelf->rv32e__DOT__mem_wb_func3)) 
                               & (~ (IData)(vlSelf->rv32e__DOT__ex_mem_alu_zero))) 
                              | ((0U == (IData)(vlSelf->rv32e__DOT__mem_wb_func3)) 
                                 & (IData)(vlSelf->rv32e__DOT__ex_mem_alu_zero))) 
                             | ((4U == (IData)(vlSelf->rv32e__DOT__mem_wb_func3)) 
                                & (IData)(vlSelf->rv32e__DOT__ex_mem_alu_less))) 
                            | ((5U == (IData)(vlSelf->rv32e__DOT__mem_wb_func3)) 
                               & (~ (IData)(vlSelf->rv32e__DOT__ex_mem_alu_less)))) 
                           | ((6U == (IData)(vlSelf->rv32e__DOT__mem_wb_func3)) 
                              & (IData)(vlSelf->rv32e__DOT__ex_mem_alu_less))) 
                          | ((7U == (IData)(vlSelf->rv32e__DOT__mem_wb_func3)) 
                             & (~ (IData)(vlSelf->rv32e__DOT__ex_mem_alu_less)))));
        ...
        if (((IData)(vlSelf->rv32e__DOT__flush) | (IData)(vlSelf->rv32e__DOT__stall))) {
            ...
            vlSelf->rv32e__DOT__id_ex_rs1_val = vlSelf->rv32e__DOT__id_rs1_val;
            vlSelf->rv32e__DOT__id_ex_rs1 = vlSelf->rv32e__DOT__id_rs1;
            vlSelf->rv32e__DOT__id_ex_rs2_val = ((0U 
                                                  == (IData)(vlSelf->rv32e__DOT__id_rs2))
                                                  ? 0U
                                                  : 
                                                 vlSelf->rv32e__DOT__wb_stage__DOT__regs
    ...
    if (vlSelf->reset) {
        ...
        vlSelf->rv32e__DOT__id_ex_valid = 0U;
        vlSelf->rv32e__DOT__if_id_valid = 0U;
        ...
        if (((IData)(vlSelf->rv32e__DOT__flush) | (IData)(vlSelf->rv32e__DOT__stall))) {
            ...
            vlSelf->rv32e__DOT__id_ex_valid = vlSelf->rv32e__DOT__id_valid;
        }
        if (vlSelf->rv32e__DOT__flush) {
            ...
            vlSelf->rv32e__DOT__if_id_valid = vlSelf->rv32e__DOT__if_valid;
    ...
    if (vlSelf->reset) {
        ...
        vlSelf->rv32e__DOT__mem_wb_valid = 0U;
        ...
        if (((IData)(vlSelf->rv32e__DOT__mem_valid) 
            ...
            vlSelf->rv32e__DOT__mem_wb_imm = vlSelf->rv32e__DOT__id_ex_imm;
            vlSelf->rv32e__DOT__mem_wb_func3 = vlSelf->rv32e__DOT__id_ex_func3;
            vlSelf->rv32e__DOT__mem_wb_opcode = vlSelf->rv32e__DOT__id_ex_opcode;
        ...
        if (((IData)(vlSelf->rv32e__DOT__mem_valid) 
             & (IData)(vlSelf->rv32e__DOT__wb_ready))) {
            vlSelf->rv32e__DOT__mem_wb_pc = vlSelf->rv32e__DOT__if_id_pc;
    ...
    if (vlSelf->reset) {
        ...
        vlSelf->rv32e__DOT__ex_mem_valid = 0U;
        ...
        if (((IData)(vlSelf->rv32e__DOT__ex_valid) 
            ...
            vlSelf->rv32e__DOT__ex_mem_rs2_val = vlSelf->rv32e__DOT__ex_rs2_val;
