...
VL_INLINE_OPT void Vrv32e___024root___nba_comb__TOP__0(Vrv32e___024root* vlSelf) {
    ...
    // Body
    vlSelf->rv32e__DOT__mem__DOT__rd_data = ((IData)(vlSelf->rv32e__DOT__ex_mem_forward_las)
                                              ? vlSelf->rv32e__DOT__ex_mem_src2
                                              : ((3U 
                                                  == (IData)(vlSelf->rv32e__DOT__mem__DOT__l_opcode))
                                                  ? 
                                                 ((0U 
                                                  ...
                                                  : 
                                                 ((0x37U 
                                                   == (IData)(vlSelf->rv32e__DOT__ex_mem_opcode))
                                                   ? vlSelf->rv32e__DOT__ex_mem_imm
                                                   : 
                                                  ((0x17U 
                                                    == (IData)(vlSelf->rv32e__DOT__ex_mem_opcode))
                                                    ? 
                                                   (vlSelf->rv32e__DOT__ex_mem_imm 
                                                    + vlSelf->rv32e__DOT__ex_mem_pc)
                                                    : 
                                                   ((0x6fU 
                                                     == (IData)(vlSelf->rv32e__DOT__ex_mem_opcode))
                                                     ? 
