...
VL_INLINE_OPT void Vrv32e___024root___nba_sequent__TOP__0(Vrv32e___024root* vlSelf) {
    ...
    vlSelf->__Vdly__rv32e__DOT__if_stage__DOT__delay 
    ...
    if (vlSelf->reset) {
        ...
        if ((0U == vlSelf->rv32e__DOT__wb_stage__DOT__state)) {
            ...
            vlSelf->rv32e__DOT__wb_valid = 0U;
            if ((0U < (IData)(vlSelf->rv32e__DOT__wb_stage__DOT__delay))) {
            ...
            if (((IData)(vlSelf->rv32e__DOT__ex_valid) 
                ...
                if (vlSelf->rv32e__DOT__MemRead) {
                    ...
                    __Vdly__rv32e__DOT__mem_stage__DOT__sram_wdata 
                        = vlSelf->rv32e__DOT__rs2_val;
                    __Vdly__rv32e__DOT__mem_stage__DOT__sram_wstrb 
                        = ((0U == (IData)(vlSelf->rv32e__DOT__MemLen))
...
VL_INLINE_OPT void Vrv32e___024root___nba_sequent__TOP__2(Vrv32e___024root* vlSelf) {
    ...
    if (vlSelf->reset) {
        ...
        vlSelf->__Vdly__rv32e__DOT__if_stage__DOT__delay = 2U;
    ...
    vlSelf->rv32e__DOT__if_stage__DOT__delay = vlSelf->__Vdly__rv32e__DOT__if_stage__DOT__delay;
    ...
    if (vlSelf->reset) {
        ...
        vlSelf->rv32e__DOT__if_stage__DOT__sram_rvalid = 0U;
        ...
        if ((0U == vlSelf->rv32e__DOT__if_stage__DOT__ifu_sram_inst__DOT__sram_state)) {
            ...
            if (vlSelf->rv32e__DOT__if_stage__DOT__sram_rready) {
                vlSelf->rv32e__DOT__if_stage__DOT__ifu_sram_inst__DOT__next_sram_state = 0U;
                vlSelf->rv32e__DOT__if_stage__DOT__sram_rvalid = 1U;
