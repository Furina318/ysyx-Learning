...
VL_ATTR_COLD void Vrv32e___024root___ctor_var_reset(Vrv32e___024root* vlSelf) {
    ...
    vlSelf->rv32e__DOT__inst_cnt = VL_RAND_RESET_I(32);
    vlSelf->rv32e__DOT__cycle_cnt = VL_RAND_RESET_I(32);
    vlSelf->rv32e__DOT__unnamedblk1__DOT__IPC = 0;
    vlSelf->rv32e__DOT__ifu__DOT__check = VL_RAND_RESET_I(1);
    vlSelf->rv32e__DOT__idu__DOT__immI = VL_RAND_RESET_I(32);
    vlSelf->rv32e__DOT__idu__DOT__immJ = VL_RAND_RESET_I(32);
    ...
    vlSelf->rv32e__DOT__exu__DOT__csr_write_data = VL_RAND_RESET_I(32);
    ...
    vlSelf->rv32e__DOT__exu__DOT____VdfgTmp_h295e95e1__0 = 0;
    vlSelf->rv32e__DOT__exu__DOT____VdfgTmp_h80abf685__0 = 0;
    ...
    vlSelf->rv32e__DOT__exu__DOT____VdfgTmp_h6c7e3f9b__0 = 0;
    vlSelf->rv32e__DOT__exu__DOT____VdfgTmp_hea419643__0 = 0;
    ...
    for (int __Vi0 = 0; __Vi0 < 256; ++__Vi0) {
        vlSelf->rv32e__DOT__lbpu__DOT__btb_tag[__Vi0] = VL_RAND_RESET_I(22);
    }
    for (int __Vi0 = 0; __Vi0 < 256; ++__Vi0) {
        vlSelf->rv32e__DOT__lbpu__DOT__btb_target[__Vi0] = VL_RAND_RESET_I(32);
    }
    for (int __Vi0 = 0; __Vi0 < 256; ++__Vi0) {
        vlSelf->rv32e__DOT__lbpu__DOT__btb_valid[__Vi0] = VL_RAND_RESET_I(1);
    }
    vlSelf->rv32e__DOT__lbpu__DOT__btb_hit_if = VL_RAND_RESET_I(1);
    vlSelf->rv32e__DOT__lbpu__DOT__btb_hit_ex = VL_RAND_RESET_I(1);
    vlSelf->rv32e__DOT__lbpu__DOT__ghr = VL_RAND_RESET_I(4);
    for (int __Vi0 = 0; __Vi0 < 256; ++__Vi0) {
        vlSelf->rv32e__DOT__lbpu__DOT__pht[__Vi0] = VL_RAND_RESET_I(2);
    }
    vlSelf->rv32e__DOT__lbpu__DOT__pht_index_if = VL_RAND_RESET_I(8);
    vlSelf->rv32e__DOT__lbpu__DOT__pht_index_ex = VL_RAND_RESET_I(8);
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        vlSelf->rv32e__DOT__lbpu__DOT__ras[__Vi0] = VL_RAND_RESET_I(32);
    }
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        vlSelf->rv32e__DOT__lbpu__DOT__ras_call_pc[__Vi0] = VL_RAND_RESET_I(32);
    }
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        vlSelf->rv32e__DOT__lbpu__DOT__recursion_depth[__Vi0] = VL_RAND_RESET_I(4);
    }
    vlSelf->rv32e__DOT__lbpu__DOT__ras_ptr = VL_RAND_RESET_I(32);
    vlSelf->rv32e__DOT__lbpu__DOT__ras_overflow = VL_RAND_RESET_I(1);
    vlSelf->rv32e__DOT__lbpu__DOT__ras_underflow = VL_RAND_RESET_I(1);
    vlSelf->rv32e__DOT__lbpu__DOT__is_recursive_call = VL_RAND_RESET_I(1);
    vlSelf->rv32e__DOT__lbpu__DOT__unnamedblk1__DOT__i = VL_RAND_RESET_I(32);
    vlSelf->rv32e__DOT__lbpu__DOT__unnamedblk2__DOT__i = VL_RAND_RESET_I(32);
    vlSelf->rv32e__DOT__lbpu__DOT__unnamedblk3__DOT__i = VL_RAND_RESET_I(32);
