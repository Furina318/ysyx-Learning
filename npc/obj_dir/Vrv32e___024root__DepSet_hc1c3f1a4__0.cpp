...
VL_INLINE_OPT void Vrv32e___024root____Vdpiimwrap_rv32e__DOT__clint__DOT__ebreak_TOP(IData/*31:0*/ station, IData/*31:0*/ inst) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vrv32e___024root____Vdpiimwrap_rv32e__DOT__clint__DOT__ebreak_TOP\n"); );
    // Body
    int station__Vcvt;
