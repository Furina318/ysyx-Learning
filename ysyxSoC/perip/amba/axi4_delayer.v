module axi4_delayer(
  ...
  // Fmax: 297MHz, Perip: 100MHz, r = 2.97
  // set s = 32, r*s = 95.04 -> 95
  // wait perip resp: counter 每周期加(r-1)*s=63.04，取整为63
  // wait apb delayer done: counter先/s = 63/32*k, 每周期-1

  localparam delay_cnt = 63;
